...
part of 'lsp_formatter_mcp_service.dart';
...
class _LspFormatterMcpService implements LspFormatterMcpService {
  _LspFormatterMcpService(this._dio, {this.baseUrl, this.errorLogger});
