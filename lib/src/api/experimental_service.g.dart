...
part of 'experimental_service.dart';
...
class _ExperimentalService implements ExperimentalService {
  _ExperimentalService(this._dio, {this.baseUrl, this.errorLogger});
